...
class SessionManager:
    ...
    """
    def __init__(self):
        self.sessions = {}  # {session_id: connection_instance}

    def create_session(self, conn_type, hostname, port=22, username=None, password=None, key_filename=None, timeout=10):
        """
        Создаёт новое подключение выбранного типа (SSH, FTP, SFTP, RDP) и возвращает уникальный session_id.
        """
        session_id = str(uuid.uuid4())
        
        # Определяем класс подключения в зависимости от протокола
